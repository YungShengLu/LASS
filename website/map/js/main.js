 ...
 */
d3.json('json/taiwan.json', function(error, taiwan) {
//d3.json('https://openlayers.org/en/v3.19.1/examples/data/topojson/us.json', function(error, us) {
    var features = topojson.feature(taiwan, taiwan.objects.layer1);
